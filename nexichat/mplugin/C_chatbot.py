...
async def delete_locked_word(client, message: Message):
    # Check if a word is provided after the command
    if len(message.text.split()) < 2:
        # Send a plain text message without specifying parse_mode
